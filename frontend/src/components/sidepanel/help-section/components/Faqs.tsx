        ...
        <View style={styles.wrapper}>
          ...
          <View>
            ...
            <Text style={styles.answer}>
              ...
              contact our customer support team through the mobile app or
              website, and we will assist you promptly.
            </Text>
          </View>
          ...
          <View>
            ...
            <Text style={styles.answer}>
              A: Yes, the minimum amount for adding funds to your Infinity
              Laundry account is $10.
            </Text>
          </View>
          <View>
            <Text style={styles.question}>
          ...
          <View>
            ...
            <Text style={styles.answer}>
              ...
              property where our laundry machines are installed. Simply log in
              to your account using the mobile app, and you can access our
